...
int luaopen_hs_libtext(lua_State* L) {
    LuaSkin *skin = [LuaSkin sharedWithState:L] ;
    ...
    //luaopen_hs_libtext_utf16(L) ; lua_setfield(L, -2, "utf16") ;
    //luaopen_hs_libtext_http(L) ;  lua_setfield(L, -2, "http") ;
    //luaopen_hs_libtext_regex(L) ; lua_setfield(L, -2, "regex") ;
