...
local module       = require("hs.libtext")
...
module.utf16 = require("hs.libtext_utf16")
module.http = require("hs.libtext_http")
module.regex = require("hs.libtext_regex")
...
--- hs.text.http.asyncGet(url, headers, callback) -> none
--- Function
...
--- hs.text.http.asyncPost(url, data, headers, callback) -> none
--- Function
