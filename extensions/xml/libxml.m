...
/// hs.xml.openDTD(url) -> xmlDTD object
/// Constructor
...
/// hs.xml.openURL(url) -> xmlDocument object
/// Constructor
...
/// hs.xml.open(file) -> xmlDocument object
/// Constructor
...
///
/// Notes:
///  * This is a wrapper for [hs.xml.openURL](#openURL) which converts the specified path into a properly formatted file URL.
...
/// hs.xml.localNameFor(qualifiedName) -> string
/// Function
...
///
/// Notes:
///  * for example, `hs.xml.localNameFor("acme:chapter")` would return `chapter`
...
/// hs.xml.prefixFor(qualifiedName) -> string
/// Function
...
///
/// Notes:
///  * for example, `hs.xml.prefixFor("acme:chapter")` would return  `acme`
...
/// hs.xml.predefinedEntityDeclaration(entityName) -> xmlDTDNode object
/// Constructor
...
/// hs.xml:rootDocument() -> xmlDocument obejct
/// Method
...
/// hs.xml:childAtIndex(index) -> xmlNode obejct
/// Method
...
/// hs.xml:nextNode() -> xmlNode object
/// Method
...
/// hs.xml:nextSibling() -> xmlNode object
/// Method
...
/// hs.xml:previousNode() -> xmlNode object
/// Method
...
/// hs.xml:previousSibling() -> xmlNode object
/// Method
...
/// hs.xml:xmlString([options]) -> string
/// Method
/// Returns the string representation of the object as it would appear in an XML document.
///
/// Parameters:
///  * options - an optional integer value made by logically OR'ing together options described in [hs.xml.nodeOptions](#nodeOptions).  Defaults to `hs.xml.nodeOptions.optionsNone`.
///
/// Returns:
...
/// hs.xml:canonicalXMLString([comments]) -> string
/// Method
...
static int xml_canonicalXMLString(lua_State *L) {
    ...
    if (lua_type(L, 2) != LUA_TNONE) preserveComments = (int)lua_toboolean(L, 2) ;

    [skin pushNSObject:[obj canonicalXMLStringPreservingComments:preserveComments]] ;
    return 1 ;
}

/// hs.xml:index() -> integer
/// Method
...
///
/// Returns:
///  * the value of the xmlObject node.  For nodes without content (for example, document nodes), this method returns the same value as [hs.xml:stringValue](#stringValue), or an empty string if there is no string value.
...
/// hs.xml:setStringValue(value) -> string
/// Method
/// Returns the content of the xmlObject as a string value.
///
/// Parameters:
...
/// hs.xml:XQuery([query], [constants]) -> table
/// Method
...
int luaopen_hs_libxml(lua_State* L) {
    LuaSkin *skin = [LuaSkin sharedWithState:L] ;
