...
local USERDATA_TAG = "hs.touchdevice"
local module       = require("hs.libtouchdevice")
module.forcetouch  = require("hs.libtouchdevice_forcetouch")
module.watcher     = require("hs.libtouchdevice_watcher")
