...
// static const char * const USERDATA_TAG = "hs.touchdevice.forcetouch" ;
...
/// hs.touchdevice.forcetouch.feedback(type, [immediate]) -> boolean
/// Function
...
/// hs.touchdevice.forcetouch.deviceAttached() -> boolean
/// Function
...
int luaopen_hs_libtouchdevice_forcetouch(lua_State* L) {
    LuaSkin *skin = [LuaSkin sharedWithState:L] ;
// Use this if your module doesn't have a module specific object that it returns.
   refTable = [skin registerLibrary:"hs.touchdevice.forcetouch" functions:moduleLib metaFunctions:nil] ; // or module_metaLib
