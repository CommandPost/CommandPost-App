...
static const char * const USERDATA_TAG = "hs.touchdevice" ;
...
/// hs.touchdevice.absoluteTime() -> number
/// Function
...
/// hs.touchdevice.available() -> boolean
/// Function
...
/// hs.touchdevice.default() -> touchdeviceObject
/// Constructor
...
/// hs.touchdevice.forDeviceID(idNumber) -> touchdeviceObject
/// Constructor
...
///
/// Notes:
///  * You can get a list of currently available device ids with [hs.touchdevice.devices](#devices) or get the device id for an existing object with [hs.touchdevice:deviceID](#deviceID).
...
/// hs.touchdevice:deviceID() -> integer
/// Method
...
/// hs.touchdevice:ioserviceDetails() -> table
/// Method
...
///
/// Notes:
///  * This method is provided for infomration purposes only; while this method will return more information than [hs.touchdevice:details](#details) it is uncertain if the additional information will actually be useful outside the context of IOKit.
...
/// hs.touchdevice:serialNumber() -> string
/// Method
...
/// hs.touchdevice:builtin() -> boolean
/// Method
...
/// hs.touchdevice:supportsForce() -> boolean
/// Method
...
/// hs.touchdevice:supportsActuation() -> boolean
/// Method
...
/// hs.touchdevice:opaqueSurface() -> boolean
/// Method
...
/// hs.touchdevice:running() -> boolean
/// Method
...
///
/// Notes:
///  * See [hs.touchdevice:start](#start) and [hs.touchdevice:stop](#stop)
...
/// hs.touchdevice:MTHIDDevice() -> boolean
/// Method
...
/// hs.touchdevice:driverReady() -> boolean
/// Method
...
/// hs.touchdevice:supportsPowerControl() -> boolean
/// Method
...
/// hs.touchdevice:productName() -> string
/// Method
...
/// hs.touchdevice:sensorDimensions([inHmm]) -> sizeTable
/// Method
...
static int touchdevice_sensorDimensions(lua_State *L) {
    ...
    ASMTouchDevice *obj = [skin toNSObjectAtIndex:1] ;
    MTDeviceRef device = obj.touchDevice ;
    BOOL inHmm = (lua_gettop(L) == 2) ? (int)lua_toboolean(L, 2) : YES ;
    int width, height ;
...
/// hs.touchdevice:familyID() -> integer
/// Method
...
/// hs.touchdevice:version() -> integer
/// Method
...
/// hs.touchdevice:driverType() -> integer
/// Method
...
/// hs.touchdevice:supportsSilentClick() -> boolean
/// Method
...
/// hs.touchdevice:forceResponseEnabled([state]) -> touchdeviceObject | boolean
/// Method
...
///    * If you have multiple userdata objects for the *same* touch device created independently (with separate [hs.touchdevice.default](#default) or [hs.touchdevice.forDeviceID](#forDeviceID) function invocations), when any of them go out of scope and is garbage collected, mouse clicks will be re-enabled for the device.
...
static int touchdevice_forceResponseEnabled(lua_State *L) {
    ...
    if (lua_gettop(L) == 1) {
        ...
        MTDeviceSetSystemForceResponseEnabled(device, (int)lua_toboolean(L, 2)) ;
        lua_pushvalue(L, 1) ;
    }
    return 1 ;
}

/// hs.touchdevice:frameCallback([fn]) -> touchdeviceObject | fn
/// Method
...
///    * `touch`     - a table containing an array of touch tables as described in [hs.touchdevice.touchData](#touchData) for each of the current touches detected by the touch device.
...
/// hs.touchdevice:pathCallback([fn]) -> touchdeviceObject | fn
/// Method
...
///
/// Notes:
///  * The path callback appears to represent the changing data for a specific touch.  Use the `pathIndex` and `stage` as described in [hs.touchdevice.touchData](#touchData) to link callbacks when tracking a specific touch.
///
///  * the callback function should expect 4 arguments and return none.  The arguments will be as follows:
///    * `self`      - the touch device object for which the callback is being invoked for
...
///    * `touch`     - a touch tables as described in [hs.touchdevice.touchData](#touchData) for the specific touch
...
/// hs.touchdevice:start() -> touchdeviceObject
/// Method
...
/// hs.touchdevice:stop() -> touchdeviceObject
/// Method
...
int luaopen_hs_libtouchdevice(lua_State* L) {
    LuaSkin *skin = [LuaSkin sharedWithState:L] ;
    refTable = [skin registerLibraryWithObject:"hs.touchdevice"
                                     functions:moduleLib
